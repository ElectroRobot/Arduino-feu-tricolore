# Arduino-feu-tricolore

Ce repository enregistre le code C++ écrit sous Arduino IDE créé pour cette activité de découverte proposée par Electro Robot. 
Plus de détails, vous pouvez vous faire référence à : [feu tricolore avec Arduino UNO](https://electro-robot.com/les-activites/activite-de-decouverte-realisation-dun-feu-tricolore-avec-arduino-uno)
